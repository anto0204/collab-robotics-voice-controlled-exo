/*
  Titolo: WiFi Web Server Servo Safe Minimum Jerk_V1 (Smart Attach)
  Descrizione: 
  - Server WiFi per ricevere comandi.
  - Controllo Servo con libreria standard Servo.h.
  - SAFETY: Se il motore si blocca, si stacca.
  - SMART ATTACH: Quando si riattiva il motore, legge la posizione attuale
    e rimane lì senza scatti improvvisi.
*/
...
void updateControlStep() {
  ...
  // 5) debug
  /*Serial.print("targetPhys=");  Serial.print(targetPhys);
  Serial.print(" cmdPhys=");    Serial.print(cmdPhys);
  Serial.print(" posDeg=");     Serial.print(posDegFilt);
  Serial.print(" err=");        Serial.print(err);
  Serial.print(" dpos=");       Serial.print(dpos);
  Serial.print(" stillCount="); Serial.print(stillCount);
  Serial.print(" safetyStop="); Serial.println(safetyStop ? "YES" : "NO");*/
